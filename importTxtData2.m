function [stoptorque,goal_current,current,velocity,position,Fx,Fy,Fz,Mx,My,Mz,counterclock,Time] = importData(filename, startRow, endRow)
...
%
% Example:
%   [stoptorque,goal_current,current,velocity,position,Fx,Fy,Fz,Mx,My,Mz,counterclock,Time] = importfile('Plots.txt',2, 3954);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2017/08/29 13:25:52
