function [t,accx1,accy1,accz1] = importfile(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as column vectors.
%   [T,ACCX1,ACCY1,ACCZ1] = IMPORTFILE(FILENAME) Reads data from text file
%   FILENAME for the default selection.
%
%   [T,ACCX1,ACCY1,ACCZ1] = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads
%   data from rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   [t,accx1,accy1,accz1] = importfile('trial1.txt',1, 370);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2017/12/21 11:57:37
