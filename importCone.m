function [Fx1,Fz1,M_max,M_min] = importCone(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as column vectors.
%   [FX1,FZ1,M_MAX,M_MIN] = IMPORTFILE(FILENAME) Reads data from text file
%   FILENAME for the default selection.
%
%   [FX1,FZ1,M_MAX,M_MIN] = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads
%   data from rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   [Fx1,Fz1,M_max,M_min] = importfile('cone.txt',2, 5601);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2017/08/29 13:29:15
